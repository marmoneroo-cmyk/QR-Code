  ...
  return (
    ...
    >
      <div className="flex max-w-md flex-col items-center gap-5">
        ...
        <h1 className="text-[26px] text-amber-50" style={{ fontFamily: isHe ? serifHe : serif }}>
          {copy.title}
        </h1>
        <p className="max-w-[34ch] text-[13.5px] leading-relaxed text-white/50" style={{ fontFamily: sans }}>
          {copy.message}
        </p>
        <div className="mt-1 flex items-center gap-3">
          {reset && (
            <button
              type="button"
              onClick={reset}
              className="inline-flex items-center gap-2 rounded-full bg-amber-100 px-6 py-3 text-[13px] font-semibold text-black transition-colors hover:bg-amber-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-200/60"
