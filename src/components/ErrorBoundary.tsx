  ...
  render(): ReactNode {
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-4 p-8 text-center">
        <p
          className="text-amber-200/70 text-[10px] tracking-[0.4em] uppercase"
        ...
        <button
          ...
          className="px-5 py-2 rounded-full border border-amber-200/40 text-amber-100 hover:bg-amber-200/10 transition-colors text-[11px] tracking-[0.3em] uppercase"
          style={{ fontFamily: 'var(--font-inter, sans-serif)' }}
        >
          Try again
        </button>
